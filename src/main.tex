...
%      \CVItemListEnd
    \CVSubheading
      ...
      \CVItemListStart
        \CVItem{Develop client side application on TypeScript, React}
      \CVItemListEnd
    \CVSubheading
...
%      {Institution you worked with}{unused}
    \CVSubheading
      ...
      Separate components were written, packed in docker containers, for interaction between each other.}{}
    \CVSubheading
    ...
    \CVSubheading
      ...
      {Implemented work with OpenWeatherMap API, with the translation of international names of weather 
      event to Russian language. Also, there is a measurement of the main indicators inside the room. 
      The data is presented on the LCD screen and the server is sent, where the infographics are displayed 
      and the saved in database.}{}
  \CVSubHeadingListEnd
...
%      {Short Description}{}
    \CVSubheading
      {The final stage of the olympiad “I am professional}{Winter 2020}
      {}{Moscow, Russia}
    \CVSubheading
    {WINTER SCHOOL URFU "SOFTWARE ENGINEERING AND RADIO ENGINEERING"}{Spring 2020}
    {}{Sochi, Russia}
  \CVSubHeadingListEnd
