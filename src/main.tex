...
%      \CVItemListEnd
    \CVSubheading
      ...
      \CVItemListStart
        ...
        \CVItem{Performing tasks to support the client side of IDM Clinic}
    ...
    \CVSubheading
      ...
      {Singularis Lab LLC.}{Volgograd, Russia}
      \CVItemListStart
        \CVItem{Develop client side application of manual testing system on TypeScript, React}
    \CVItemListEnd
    \CVSubheading
...
%      {Institution you worked with}{unused}
    \CVSubheading
      ...
      for interaction between each other.}{}
    \CVSubheading
