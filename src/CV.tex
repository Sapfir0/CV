...
\section{Work Experience}
  \CVSubHeadingListStart
    \CVSubheading
      {Middle Frontend Developer}{October 2021 -- Present}
    ...
    \CVSubheading
      {Software Engineer Intern}{July 2021 -- August 2021}
    ...
    \CVItemListStart
      ...
      \CVItem{Developed sandbox for VTune React components. The sandbox helped to find and fix a bug in the dropbox component (React, TS)}
    \CVItemListEnd

    \CVSubheading
      {Junior Frontend Developer}{November 2020 -- June 2021}
